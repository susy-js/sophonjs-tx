// see full article here https://wanderer.github.io/sophon/2014/06/14/creating-and-verifying-transaction-with-node/

var Transaction = require('../index.js')

// create a blank transaction
var tx = new Transaction(null, 1) // mainnet Tx SIP155
...
// Now that we have the serialized transaction we can get AlsofZero to except by
...
// it directly from the network it will be srlp encoded. You can decode you the srlp
...
// Note srlp.decode will actully produce an array of buffers `new Transaction` will
