...
const common = require('sophon-common/params.json')

var txTests = testing.getTests('transaction', argv)

const bufferToHex = sofUtil.bufferToHex
const addHexPrefix = sofUtil.addHexPrefix
const stripHexPrefix = sofUtil.stripHexPrefix
const setLength = sofUtil.setLength
...
testing.runTests(function (testData, sst, cb) {
  ...
  try {
    var rawTx = sofUtil.toBuffer(testData.srlp)
    var tx = new Tx(rawTx)
