 ...
 * @constructor
 * @class {Buffer|Array} data a transaction can be initiailized with either a buffer containing the SRLP serialized transaction or an array of buffers relating to each of the tx Properties, listed in order below in the exmple. Or lastly an Object containing the Properties of the transaction like in the Usage example
 *
 ...
 * @prop {Buffer} raw The raw srlp decoded transaction
 * @prop {Buffer} nonce
 * @prop {Buffer} to the to address
 * @prop {Buffer} value the amount of sophy sent
...
module.exports = class FakeTransaction extends Transaction {
  constructor (data) {
    ...
    Object.defineProperty(this, 'from', {
      ...
      set: function (val) {
        if (val) {
          self._from = sofUtil.toBuffer(val)
        }
      }
    })
